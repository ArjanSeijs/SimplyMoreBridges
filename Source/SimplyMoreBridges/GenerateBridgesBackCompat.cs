...
public static class GenerateBridgesBackCompat
{
    ...
    private static void TryAddDef(TerrainDef terrainDef)
    {
        try
        {
        ...
        string alternateTexture = "")
    {
        ...
        switch (bridgeType)
        {
            case BridgeType.Wooden:
                ...
                currentBridgeType.canGenerateDefaultDesignator = false; // [No Designator]
